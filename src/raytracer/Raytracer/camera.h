...
class camera {
  public:
    ...
    unsigned int    image_width       = 100;  // Rendered image width in pixel count
    unsigned int    image_height;         // Rendered image height
        ...
        for (unsigned int j = 0; j < image_height; j++) {
            ...
            for (unsigned int i = 0; i < image_width; i++) {
                ...
                // Write pixel
                {
                    ...
                    const size_t index = (j * image_width + i) * 4;
  ...
  private:
    ...
    void initialize() {
        image_height = (unsigned int)(image_width / aspect_ratio);
